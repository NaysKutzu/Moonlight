...
namespace Moonlight.App.Database.Migrations
{
    ...
    [Migration("20230511180157_AddedShardModels")]
    partial class AddedShardModels
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Moonlight.App.Database.Entities.Shard", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<int>("ShardPort")
                        .HasColumnType("int");

                    b.Property<int?>("ShardSpaceId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ShardSpaceId");

                    b.ToTable("Shards");
                });

            modelBuilder.Entity("Moonlight.App.Database.Entities.ShardAllocation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ShardAllocations");
                });

            modelBuilder.Entity("Moonlight.App.Database.Entities.ShardProxy", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("ShardProxies");
                });

            modelBuilder.Entity("Moonlight.App.Database.Entities.ShardSpace", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Moonlight.App.Database.Entities.Server", b =>
                {
                    ...
                    b.HasOne("Moonlight.App.Database.Entities.ShardAllocation", "MainAllocation")
                        .WithMany()
                    ...
                    b.HasOne("Moonlight.App.Database.Entities.Shard", "Shard")
                        .WithMany()
            ...
            modelBuilder.Entity("Moonlight.App.Database.Entities.Shard", b =>
                {
                    b.HasOne("Moonlight.App.Database.Entities.ShardSpace", null)
                        .WithMany("Shards")
                        .HasForeignKey("ShardSpaceId");
                });
            ...
            modelBuilder.Entity("Moonlight.App.Database.Entities.ShardAllocation", b =>
                {
                    ...
                    b.HasOne("Moonlight.App.Database.Entities.Shard", null)
                        .WithMany("Allocations")
                        .HasForeignKey("ShardId");
                });
            ...
            modelBuilder.Entity("Moonlight.App.Database.Entities.ShardSpace", b =>
                {
                    b.HasOne("Moonlight.App.Database.Entities.ShardProxy", "Proxy")
                        .WithMany()
